...
> **Projektstatus:** AP10 hat den abgenommenen AP8-Rechenkern und die AP9-MVP-Oberfläche in ein gemeinsames SPFx-WebPart für SharePoint und Microsoft Teams integriert. Der korrigierte Kandidat `0.1.0.2` ist reproduzierbar gebaut, im steimer.ch-Tenant-App-Katalog aktiviert und auf der dedizierten Testsite aktualisiert. Die vollständige SharePoint-Wiederholungsprüfung T03 bis T08 ist bestanden. Das Paket ist zusätzlich auf der SharePoint-Website des Teams `Entwicklungsumgebung` installiert. Die direkte organisationsinterne Teams-App mit derselben Component-ID ist publiziert, entsperrt, für alle verfügbar und als Registerkarte `Fristenrechner Schweiz – Teams` im bezeichneten Kanal installiert. T09 bis T12 sind bestanden. Alle 65 bestehenden TypeScript-Tests und alle 12 SPFx-Provider- und Integrationsprüfungen bestehen. Der Teams-Mirror bleibt unkonfiguriert und Gastzugriffe bleiben gesperrt. Es besteht noch keine produktiv freigegebene Anwendung.
