...
Der [abgenommene AP14-Ausführungsplan](docs/betrieb/gastzugriff-demobetrieb-ap14.md) grenzt die geplante Gastdemo auf authentifizierte B2B-Konten, eine eigene SharePoint-Site, ein separates Demo-Team und einen nur lesbaren same-site Mirror ein. Anonyme Freigaben und der Zugriff auf interne Entwicklungsressourcen sind ausdrücklich ausgeschlossen. Die Durchführung beginnt erst mit einem ausdrücklichen Startauftrag.
