...
AP7 hat den technischen Machbarkeitsspike ausführungsbereit geplant und ist abgenommen. `SPK-SPFX-01` ist technisch abgeschlossen. Alle Prüfungen T01 bis T14 sind bestanden. DEC-2026-013 legt SPFx als gemeinsame Zielarchitektur für SharePoint und Teams fest. AP10 hat daraus einen vollständig gebauten Installationskandidaten mit Rechenkern und MVP-Oberfläche erstellt. Die erste SharePoint-Prüfung bestätigte die fachliche Funktion und deckte einen CSS-Verpackungsfehler auf. Der lokal nachgewiesene Korrekturkandidat `0.1.0.1` muss im Tenant erneut geprüft werden. Die Teams-Prüfung steht aus. Der Teams-Mirror und allfällige Gastzugriffe bleiben bewusst eigenen Folgeprüfungen vorbehalten.
