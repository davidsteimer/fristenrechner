...
| `OF-004` | Welche Spezialgesetze enthalten zusätzliche Stillstands- oder Fristregeln? | besonders VwVG und VRPG Bern | nur die im Kernprofil ausdrücklich erfassten Ausnahmen automatisieren. Nutzer muss bestätigen, dass keine unbekannte Spezialregel greift | Aufnahme einer neuen Sachmaterie oder eines neuen Rechtswegs | hoch |
